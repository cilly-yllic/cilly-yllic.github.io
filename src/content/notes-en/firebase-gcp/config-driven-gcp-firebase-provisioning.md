...
description: 'The design of a platform that chains GCP project creation through Firebase setup, keyless, with a per-service settings file as the source of truth.'
...
![Architecture diagram of the multi-environment GCP / Firebase platform](/images/multi-environment-gcp-firebase-platform-architecture.png)
...
![Architecture diagram of the infrastructure generation pipeline](/images/gcp-firebase-platform-architecture.png)
