    ...
    items: [
      {
        icon: 'php',
        title: 'PHP',
        line: { text: '4年', level: 5 },
        tooltip: 'バックエンド（ブラウザゲーム・社内ツール、自社開発など）',
      },
      ...
      { icon: '', title: 'TypeScript', line: { text: '5年以上', level: 5 }, tooltip: '' },
      {
        icon: '',
        title: 'CSS',
        line: { text: '5年以上', level: 3 },
        tooltip: 'UIライブラリなども併用し、開発は可能だが\nスマートな開発や構造化等は苦手。',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { icon: '', title: 'Rails', line: { text: '1年未満', level: 5 }, tooltip: '趣味レベル' },
      {
        icon: '',
        title: 'Python',
        line: { text: '1年未満', level: 5 },
        tooltip: '趣味レベルでOpenCVとTesseractを使って画像解析処理の実装',
      },
      { icon: '', title: 'React', line: { text: '1年未満', level: 5 }, tooltip: '現在プライベートで開発中' },
      {
        ...
        title: 'Flutter',
        line: { text: '1年未満', level: 5 },
        tooltip: '環境構築や軽微な修正、Firebaseとの繋ぎ込みやemulatorなどの機能実装）',
      },
    ],
  },
]
