...
description: 'A development environment with multiple services sharing one GCP project, presented through two cross-sections: how it runs (runtime) and how it ships (delivery).'
...
![Runtime architecture and data flow](/images/runtime-architecture-and-data-flow.png)
...
[Treating Firestore as a public cache](/en/notes/firebase-gcp/firestore-as-public-cache/)
...
![Multi-target deployment architecture from the monorepo](/images/nx-monorepo-deployment-architecture.png)
...
[Provisioning GCP / Firebase environments from a single settings.yml](/en/notes/firebase-gcp/config-driven-gcp-firebase-provisioning/)
